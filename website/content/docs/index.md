...
description: Learn Khora, a native language for reliable concurrent applications.
template: splash
hero:
  tagline: Native performance, typed failure, capabilities, and structured concurrency in direct-style code.
  actions:
    - text: Get started
