...
The compiler checks pattern exhaustiveness and unreachable arms. See [Pattern matching](./pattern-matching.md) for all pattern forms.
...
See [Typed failure with raises](./errors-and-raises.md) for the full failure model.