...
Go to definition, completion and rename are 14.3, 14.4 and 14.8, and are not
there yet. `vim.lsp.buf.definition()` will do nothing rather than something
wrong: the server does not advertise the capability.
